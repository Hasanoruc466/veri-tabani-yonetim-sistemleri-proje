...
namespace WindowsFormsApp1
{
    public partial class Form3 : Form
    {
        ...
        {
            c1.Open();
            NpgsqlCommand ekleme = new NpgsqlCommand("insert into \"OgretimUyesi\"(id, ad, soyad, \"TCKNo\", \"sicilNo\", bolum) values(@p1,@p2,@p3,@p4,@p5,@p6)", c1);
        ...
        {
            c1.Open();
            NpgsqlCommand guncelle = new NpgsqlCommand("update \"OgretimUyesi\" set ad=@p1, soyad=@p2, bolum=@p3 where id=@p4", c1);
        ...
        {
            c1.Open();
            NpgsqlCommand silme = new NpgsqlCommand("Delete from \"OgretimUyesi\" where id=@p1", c1);
        ...
        {
            string q2 = "Select id,ad,soyad,\"TCKNo\",\"sicilNo\",bolum from \"OgretimUyesi\"";
